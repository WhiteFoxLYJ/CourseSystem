...
<html>
  ...
  <body>
    This is EduadminFunction.jsp<hr>
    ...
    <input type="button" value="录入教室" id="Edu_AddRoom_but">
      <input type="button" value="录入课程" id="Edu_AddCourse_but">
       <input type="button" value="安排课程" id="Edu_PLanCourse_but">
        ...
        <div id="roomInfo">
        	<table id="roomInfoTable" style =" display: none;height: auto; width: 800px" border="1">
        		<tr>
        			<td>教室编号</td>
        			<td>教室类型</td>
        			<td>可容纳人数</td>
        ...
        <div id="roomAdd">
        	<table id="roomAddTable" style =" display: none;height: auto; width: 800px" border="1">
        		<tr>
        			<td>教室类型</td>
        			<td>
